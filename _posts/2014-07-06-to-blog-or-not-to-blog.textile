...
And also, updating the design of this site has forced me to use again some old tools that I haven’t used in years. I do some front-end dev at work, but we are a "Rails":http://rubyonrails.org/ shop so my workflow has evolved A LOT. Using "Textpattern":http://textpattern.com/ again was difficult, it felt like going back in time 10 years! I didn’t feel comfortable at all, but I found this little "plugin":https://github.com/whaleen/txp.foundation/blob/master/textpattern/plugins/cnk_versioning.txt (a real lifesaver) that allowed me to develop using flat files, so I could at least use "Git":http://git-scm.com/ and "Sass":http://sass-lang.com/ within TXP. But this is probably the last time I update a Textpattern website. Don't get me wrong, Textpattern is still a solid and flexible CMS that works for some people, but it just feels dated. Next time I might be migrating to "Jekyll":http://jekyllrb.com/, "Kirby":http://getkirby.com/ or something similar. Sign of the times.
