...
This website was sponsored by the Friends, a family of farmers based in Tulare, California. The Friends already had a successful experience with a prior non-web version of Horsepower, so they had a solid idea of the business goals and an extensive knowledge of our customers. With the information they provided we added new features to the site and we reimagined the user experience, and all that process ended in the release of a new version of the site 6 months after I joined the team.
<figure>
!/images/hp-wf.png(wireframe of horsepower)!
<figcaption>Early wireframe of the home page.</figcaption>
</figure>
Some quick tech notes: the web was developed using "ASP.NET":http://www.asp.net/ and the front-end was based on the "Bootstrap":http://getbootstrap.com/ framework from Twitter, which was new at that time.
