...
At that point, we realized we needed to make changes, promote a more consistent design and refactor our CSS. The best way we found to establish and promote good practice was to use a live style guide. We used the same software GitHub used for their "Style Guide":https://github.com/styleguide/css, and it allowed us to automatically update our style guide after any changes were made on the CSS of the site.
<figure>
...
In order to improve CSS scalability, we decided to build our own framework after a failed experiment with a popular UI framework. We followed the "SMACSS":https://smacss.com/ methodology for the structure and the "BEM":https://en.bem.info/ naming convention for the styles naming. You can learn more about the refactor process in this "blog post":/blog/i-refactored-css-for-9-months-and-i-survived/ I wrote a few months ago.
