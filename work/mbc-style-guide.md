...
<p>At that point, we realized we needed to make changes, promote a more consistent design and refactor our <span class="caps">CSS</span>. The best way I found to establish and promote good practice was to use a live style guide. I used the same software GitHub used for their <a href="https://github.com/styleguide/css">Style Guide</a>, and it allowed us to automatically update our style guide after any changes were made on the <span class="caps">CSS</span> of the site.<br />
<figure>
<img src="/images/mbc-sg-detail.png" title="Screenshot of MBC Style Guide" alt="Screenshot of MBC Style Guide" /><br />
<figcaption>Every module of the style guide included a snippet of code.</figcaption></p>
</figure>
